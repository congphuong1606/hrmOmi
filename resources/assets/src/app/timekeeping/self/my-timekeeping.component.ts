import { Component, OnInit, AfterViewInit, AfterViewChecked, HostListener, ElementRef } from "@angular/core";
...
@Component({
    selector: 'my-timekeeping-cmp',
    moduleId: module.id,
    templateUrl: 'my-timekeeping.component.html'
})

export class MyTimekeepingComponent implements OnInit, AfterViewInit, AfterViewChecked {
    ...
    constructor(private fb: FormBuilder,
        ...
        this.employee_id = this.globalDataService.getEmployId();
        this.isAdvancedAdmin = this.globalDataService.isAdvancedAdmin();
        console.log(this.isAdvancedAdmin);
    }

    ngOnInit() {
        if (!this.globalDataService.checkPemisson('/cham-cong/bang-ca-nhan')) {
    ...
    getTotalListTimeKeepingMonths() {
        ...
        this.personnelService.getTotalListTimeKeepingMonthsEmployee(this.employee_id).subscribe(
            data => {
    ...
    getTimeOn() {
        this.loaderController.pushLoader();
        this.personnelService.getTimeOnEmployee(this.selectedMonth, this.employee_id).subscribe(
            data => {
                this.loaderController.releaseLoader();
