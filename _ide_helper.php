 ...
 * Generated for Laravel 5.4.36 on 2018-07-02 13:59:27.
 *
...
namespace Mavinoo\LaravelBatch { 
    ...
    class LaravelBatchFacade {
        ...
        {
            return \Mavinoo\LaravelBatch\Batch::update($table, $values, $index);
        }
        ...
        {
            return \Mavinoo\LaravelBatch\Batch::insert($table, $columns, $values, $batchSize);
        }
